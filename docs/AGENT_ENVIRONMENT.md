...
Expected result: **23/23 suites pass**, total runtime roughly **3–6 min** on
a typical development machine — the wall clock is dominated by the suites
...
bash tests/run_all_tests.sh     # 23/23 suites PASSED, exit 0 (3–6 min)
