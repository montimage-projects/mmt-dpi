...
tests/run_all_tests.sh:190-219	^DEFAULT_SUITES=\(	^\)$	the default suite list lives in DEFAULT_SUITES	sdk_coverage
tests/run_all_tests.sh:232-355	^# --- coverage report	^fi$	--coverage writes an lcov tracefile and a line rate	coverage\.info
...
tests/run_all_tests.sh:256-260	json_file=	select\(	coverage restricts emitted records to src	/src/
tests/run_all_tests.sh:317-331	Instrumented files	scope:	coverage summary exposes measured scope	instrumented_sources
