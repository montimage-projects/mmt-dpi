...
- Test: `bash tests/run_all_tests.sh` — the 12 suites compile standalone against `src/`, no prior build or install needed; [docs/AGENT_ENVIRONMENT.md §3](docs/AGENT_ENVIRONMENT.md#3-testing) is authoritative for that count, the runtime band and the exit codes
