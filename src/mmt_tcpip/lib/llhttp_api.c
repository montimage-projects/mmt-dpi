 ...
 * (generated release source src/api.c, renamed llhttp_api.c here to keep
 * the flat src/mmt_tcpip/lib/ namespace unambiguous; MIT licence). Do
 * not hand-edit: local changes diverge from upstream and are lost on
 * the next vendor bump — regeneration from the TypeScript sources is a
 * maintainer-only step; see docs/llhttp-migration.md. Excluded from the
