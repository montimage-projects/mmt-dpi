 ...
 * (generated release source include/llhttp.h; MIT licence). Do not
 * hand-edit: local changes diverge from upstream and are lost on the
 * next vendor bump — regeneration from the TypeScript sources is a
