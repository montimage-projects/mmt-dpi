...
# #466/#468: the parser reports the rules sets and quality metrics it drops
# instead of leaking them.
for msg in "Several <rules> nodes" "<rules> without a quality metric" \
        "Cannot register the <indexs> quality metric"; do
